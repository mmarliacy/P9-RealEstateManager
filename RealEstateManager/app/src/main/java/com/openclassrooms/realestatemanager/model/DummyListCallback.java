...
public class DummyListCallback {
    ...
    public static List<PropertyModel> DUMMY_PROPERTIES = Arrays.asList(
            new PropertyModel("1", "Charmed",
                    "Loft", "Rue Pierre Loti, 91330 Yerres",
            ...
            new PropertyModel("2", "White Shield",
                    "Apartment", "2 All. Danton, 91270 Vigneux-sur-Seine",
            ...
            new PropertyModel("3", "Run House",
                    "House", "27B Rue Piard, 94450 Limeil-Brévannes",
            ...
            new PropertyModel("1", "Brown Champagne",
                    "Chalet", "Pl. des Droits de l'Homme, 91800 Boussy-Saint-Antoine",
            ...
            new PropertyModel("3", "Cosy Place",
                    "Mobil-Home", "822-825 All. Jean Papadopoulos, 94190 Villeneuve-Saint-Georges",
