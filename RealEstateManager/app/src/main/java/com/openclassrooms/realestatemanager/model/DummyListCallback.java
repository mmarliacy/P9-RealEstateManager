...
public class DummyListCallback {
    ...
    public static List<PropertyModel> DUMMY_PROPERTIES = Arrays.asList(
            new PropertyModel(1, 1, "Charmed",
                    ...
                    "01/10/2021", ""),
            new PropertyModel(2, 2, "White Shield",
                    ...
                    "12/12/2021", ""),
            new PropertyModel(3, 3, "Run House",
            ...
            new PropertyModel(4, 1, "Brown Champagne",
            ...
            new PropertyModel(5, 3, "Cosy Place",
    ...
    public static List<InterestModel> setInterestsNameListToIcon() {
